        ...
        <section id="como-funciona" className="mt-24">
          ...
          <div className="mt-10 grid gap-6 lg:grid-cols-4">
            <div className="relative min-w-0">
              ...
              <div className="mt-5 h-[25.5rem] rounded-3xl border border-border bg-surface p-5 shadow-soft"><NewInvoiceMockup /></div>
            ...
            <div className="relative min-w-0">
              ...
              <div className="mt-5 h-[25.5rem] rounded-3xl border border-border bg-surface p-5 shadow-soft"><StampedInvoiceMockup /></div>
              <div className="absolute left-[calc(100%+0.75rem)] top-34 hidden w-6 items-center lg:flex" aria-hidden="true">
                <div className="w-full border-t border-dashed border-primary/50" /><ArrowRight className="-ml-0.5 size-3 shrink-0 text-primary/70" />
              </div>
            </div>
            ...
            <div className="relative min-w-0">
              ...
              <div className="mt-5 h-[25.5rem] rounded-3xl border border-border bg-surface p-5 shadow-soft"><InvoiceListMockup /></div>
              <div className="absolute left-[calc(100%+0.75rem)] top-34 hidden w-6 items-center lg:flex" aria-hidden="true">
                <div className="w-full border-t border-dashed border-primary/50" /><ArrowRight className="-ml-0.5 size-3 shrink-0 text-primary/70" />
              </div>
            </div>
            ...
            <div className="min-w-0">
              ...
              <div className="mt-5 h-[25.5rem] rounded-3xl border border-border bg-surface p-5 shadow-soft"><InvoiceDetailMockup /></div>
            </div>
          </div>
